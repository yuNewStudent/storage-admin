    ...
    <el-header>
      <div class="selectStore">
        ...
        <el-select filterable
                   ...
                   @change="handleFilter"
                   placeholder="请输入经办人">
          <el-option v-for="(item, index) in applicants"
                     :key="index"
                     :label="item.name"
      ...
      <div class="selectStore">
        ...
        <el-select filterable
                   ...
                   @change="handleFilter"
                   placeholder="全部">
          <el-option v-for="item in ordersStatus"
                     :key="item.label"
                     :label="item.label"
      ...
      <div class="select_date">
        ...
        <el-date-picker v-model="filter.apply_datetime"
                        type="daterange"
                        range-separator="至"
      ...
      <div class="buttons">
        <el-button type='primary'
                   size='medium'
                   @click='handleOutput'>导出</el-button>
      </div>
    </el-header>
    <el-main>
      <el-table :data="paginationData"
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button size='mini'
                       type='primary'
                       @click="outordetails(scope.$index, scope.row)">详情</el-button>
          </template>
        </el-table-column>
      ...
      <el-pagination @current-change="handleCurrentChange"
                     ...
                     :total="orders.length"></el-pagination>
      ...
      <el-table :data="datalist"
        ...
        <el-table-column label="预估总价"
                         prop='estimated_money'>
        </el-table-column>
        <el-table-column label="用途"
                         prop='purpose'>
        </el-table-column>
        <el-table-column label="申请人备注"
                         prop='apply_comment'>
        </el-table-column>
      ...
      <div class="warehousing">
        <el-button v-if="show=='待审核'"
                   type='primary'
                   size='medium'
                   @click="goodsubmit">提交</el-button>
        <el-button v-if="show=='待审核'"
                   type='primary'
                   @click="outorfallback()">回退</el-button>
      </div>
    </el-main>
  </div>
</template>
